...
Crafting ingredient for advanced recipes in the [[Stone Workbench]].
Can either be made from copper or iron, requires at least a ==copper hammer== to craft.
![[Pasted image 20250821160347.png]]
...
`INPUT[inlineSelect(option(No), option(Done), option(Vanilla), option(N/A), option(WIP)):Localization]` Localization
`INPUT[inlineSelect(option(No), option(Done), option(Vanilla), option(N/A), option(WIP)):Sound]` Sound

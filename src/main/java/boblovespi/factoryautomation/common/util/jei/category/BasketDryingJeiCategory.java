...
public class BasketDryingJeiCategory extends FAJeiCategory<BasketDryingRecipe>
{
	public BasketDryingJeiCategory(IGuiHelper helper)
	{
		super(RecipeThings.BASKET_DRYING_TYPE.get(), helper, FABlocks.BAMBOO_BASKET, FactoryAutomation.locString("jei", "basket_drying.name"));
	}

	@Override
	public void setRecipe(IRecipeLayoutBuilder builder, RecipeHolder<BasketDryingRecipe> recipe, IFocusGroup focuses)
	{
	...
	@Override
	public void draw(RecipeHolder<BasketDryingRecipe> recipe, IRecipeSlotsView recipeSlotsView, GuiGraphics graphics, double mouseX, double mouseY)
	{
	...
	private record Background(IDrawable bg) implements IDrawable
	{
		...
		public void draw(GuiGraphics guiGraphics, int xOffset, int yOffset)
		{
			...
			guiGraphics.pose().pushPose();
			{
				...
				guiGraphics.renderFakeItem(FABlocks.BAMBOO_BASKET.toStack(), 0, 0);
			}

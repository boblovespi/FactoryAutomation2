...
public class KilnJeiCategory extends FAJeiCategory<KilnRecipe>
{
	public KilnJeiCategory(IGuiHelper helper)
	{
		super(RecipeThings.KILN_TYPE.get(), helper, FABlocks.BRICK_KILN, FactoryAutomation.locString("jei", "kiln.name"));
	}

	@Override
	public void setRecipe(IRecipeLayoutBuilder builder, RecipeHolder<KilnRecipe> recipe, IFocusGroup focuses)
	{
	...
	@Override
	public void draw(RecipeHolder<KilnRecipe> recipe, IRecipeSlotsView recipeSlotsView, GuiGraphics graphics, double mouseX, double mouseY)
	{
		...
		graphics.drawString(Minecraft.getInstance().font, I18n.get("misc.temperature", recipe.value().getData().temperature()), 60, 66, 0xff545454, false);
	}
	...
	private record Background(IDrawable bg) implements IDrawable
	{
		...
		public void draw(GuiGraphics guiGraphics, int xOffset, int yOffset)
		{
			...
			guiGraphics.pose().pushPose();
			{
				...
				guiGraphics.renderFakeItem(FABlocks.BRICK_KILN.toStack(), 0, 0);
			}

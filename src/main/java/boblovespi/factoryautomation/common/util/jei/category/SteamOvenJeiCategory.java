...
public class SteamOvenJeiCategory extends FAJeiCategory<SteamOvenRecipe>
{
	private static final DecimalFormat FORMATTER = new DecimalFormat("#.#");

	public SteamOvenJeiCategory(IGuiHelper helper)
	{
		super(RecipeThings.STEAM_OVEN_TYPE.get(), helper, FABlocks.STEAM_OVEN, FactoryAutomation.locString("jei", "steam_oven.name"));
	}
	...
	@Override
	public void setRecipe(IRecipeLayoutBuilder builder, RecipeHolder<SteamOvenRecipe> recipe, IFocusGroup focuses)
	{
	...
	@Override
	public void draw(RecipeHolder<SteamOvenRecipe> recipe, IRecipeSlotsView recipeSlotsView, GuiGraphics graphics, double mouseX, double mouseY)
	{
	...
	private record Background(IDrawable bg) implements IDrawable
	{
		...
		public void draw(GuiGraphics guiGraphics, int xOffset, int yOffset)
		{
			...
			guiGraphics.pose().pushPose();
			{
				...
				guiGraphics.renderFakeItem(FABlocks.STEAM_OVEN.toStack(), 0, 0);
			}

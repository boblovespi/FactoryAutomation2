...
public class FABlocks
{
	...
	public static final DeferredBlock<SoybeanCrop> SOYBEAN = register("soybean", SoybeanCrop::new, BlockBehaviour.Properties.of().mapColor(MapColor.PLANT).noCollission().randomTicks().instabreak().sound(SoundType.CROP).pushReaction(PushReaction.DESTROY));
	...
	public static final DeferredBlock<WildShrub> WILD_TEA_SHRUB = register("wild_tea_shrub", WildShrub::new, BlockProperties.SHRUB);
	...
	public static final DeferredBlock<BambooBasket> BAMBOO_BASKET = register("bamboo_basket", BambooBasket::new, BlockProperties.WOOD_MACHINE);
	public static final DeferredBlock<BrickKiln> BRICK_KILN = register("brick_kiln", BrickKiln::new, BlockProperties.BRICK_MACHINE_LIT);
	public static final DeferredBlock<SteamOven> STEAM_OVEN = register("steam_oven", SteamOven::new, BlockProperties.BRICK_MACHINE);
	...
	public static final DeferredBlock<LargeWaterwheel> LARGE_WATERWHEEL = register("large_waterwheel", LargeWaterwheel::new, BlockProperties.WOOD_MACHINE_NO_OCCLUSION);
	...
	public static final DeferredBlock<ScrewPump> SCREW_PUMP = register("screw_pump", ScrewPump::new, BlockProperties.IRON_MACHINE);

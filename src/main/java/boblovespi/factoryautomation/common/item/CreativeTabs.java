...
public class CreativeTabs
{
	...
	public static void addCreative(BuildCreativeModeTabContentsEvent event)
	{
		...
		if (event.getTabKey() == CreativeModeTabs.FOOD_AND_DRINKS)
		{
			...
			insertAfter(event, Items.MELON_SLICE, FAItems.SOYBEANS, FAItems.EDAMAME, FAItems.GROUND_SOYBEAN, FAItems.SOY_SAUCE_CULTURE, FAItems.TOFU, FAItems.DOUFUNAO, FAItems.SALTY_DOUFUNAO, FAItems.SWEET_DOUFUNAO);

...
public class FAItems
{
	...
	public static final DeferredItem<BlockItem> HALITE = ITEMS.registerSimpleBlockItem(FABlocks.HALITE);
	public static final DeferredItem<BlockItem> GYPSUM = ITEMS.registerSimpleBlockItem(FABlocks.GYPSUM);
	...
	public static final DeferredItem<Item> SOYBEANS = ITEMS.registerItem("soybeans", p -> new ItemNameBlockItem(FABlocks.SOYBEAN.get(), p), p());
	public static final DeferredItem<Item> EDAMAME = ITEMS.registerSimpleItem("edamame", p().food(makeFood(2, 3 / 5f)));
	...
	public static final DeferredItem<Item> GREEN_TEA_LEAF = ITEMS.registerSimpleItem("green_tea_leaf");
	...
	public static final DeferredItem<BlockItem> BAMBOO_BASKET = ITEMS.registerSimpleBlockItem(FABlocks.BAMBOO_BASKET);
	...
	public static final DeferredItem<BlockItem> SMALL_WATERWHEEL = ITEMS.registerSimpleBlockItem(FABlocks.SMALL_WATERWHEEL);

...
public class FAWorldgen
{
	...
	public static final DeferredHolder<Feature<?>, Feature<DeltaFeatureConfiguration>> EVAPORITE_FEATURE = register("evaporite_sheet", EvaporiteFeature::new, DeltaFeatureConfiguration.CODEC);

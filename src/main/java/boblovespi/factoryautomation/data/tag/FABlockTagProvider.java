...
public class FABlockTagProvider extends BlockTagsProvider
{
	...
	protected void addTags(HolderLookup.Provider pProvider)
	{
		...
		tag(BlockTags.NEEDS_IRON_TOOL).add(Blocks.DEEPSLATE, Blocks.DEEPSLATE_BRICKS, Blocks.DEEPSLATE_BRICK_SLAB, Blocks.DEEPSLATE_BRICK_STAIRS, Blocks.DEEPSLATE_BRICK_WALL)
									  ...
									  .add(FABlocks.MAGMATIC_BRASS_BLOCK.get(), FABlocks.MAGMATIC_BRASS_PLATE_BLOCK.get(), FABlocks.MAGMATIC_BRASS_SPACE_FRAME.get())
		...
		tag(FATags.Blocks.NEEDS_COPPER_TOOL).add(FABlocks.TIN_BLOCK.get(), FABlocks.COPPER_PLATE_BLOCK.get(), FABlocks.TIN_PLATE_BLOCK.get(), FABlocks.IRON_PLATE_BLOCK.get())
											...
											.add(FABlocks.SILVER_BLOCK.get(), FABlocks.SILVER_PLATE_BLOCK.get(), FABlocks.SILVER_SPACE_FRAME.get())
		...
		tag(BlockTags.NEEDS_STONE_TOOL).add(FABlocks.CASSITERITE_ORE.get(), FABlocks.RAW_CASSITERITE_BLOCK.get())
									   .remove(FATags.Blocks.NEEDS_COPPER_TOOL)
									   .remove(BlockTags.NEEDS_IRON_TOOL);
		...
		tag(BlockTags.MINEABLE_WITH_PICKAXE).add(FABlocks.STONE_CRUCIBLE.get(), FABlocks.STONE_CASTING_VESSEL.get())
											...
											.add(FABlocks.ALUMINUM_BRONZE_BLOCK.get(), FABlocks.ALUMINUM_BRONZE_PLATE_BLOCK.get(), FABlocks.ALUMINUM_BRONZE_SPACE_FRAME.get())
											.add(FABlocks.CHROMIUM_BLOCK.get(), FABlocks.CHROMIUM_PLATE_BLOCK.get(), FABlocks.CHROMIUM_SPACE_FRAME.get())
											.add(FABlocks.IRON_POWER_SHAFT.get(), FABlocks.IRON_GEARBOX.get(), FABlocks.IRON_SPLITTER.get())
		...
		tag(BlockTags.MINEABLE_WITH_AXE).add(choppingBlocks).add(FABlocks.LOG_PILE.get(), FABlocks.BRICK_MAKER_FRAME.get(), FABlocks.PAPER_BELLOWS.get())
										.add(FABlocks.HAND_CRANK.get(), FABlocks.WOOD_POWER_SHAFT.get(), FABlocks.WOOD_GEARBOX.get(), FABlocks.WOOD_SPLITTER.get());
		...
		tag(FATags.Blocks.SILVER_BLOCK).add(FABlocks.SILVER_BLOCK.get());
		tag(FATags.Blocks.MAGMATIC_BRASS_BLOCK).add(FABlocks.MAGMATIC_BRASS_BLOCK.get());
		tag(FATags.Blocks.PIG_IRON_BLOCK).add(FABlocks.PIG_IRON_BLOCK.get());
		...
		tag(FATags.Blocks.ALUMINUM_BRONZE_BLOCK).add(FABlocks.ALUMINUM_BRONZE_BLOCK.get());
		...
		tag(FATags.Blocks.MINEABLE_WITH_WRENCH).add(FABlocks.WOOD_POWER_SHAFT.get(), FABlocks.WOOD_GEARBOX.get(), FABlocks.WOOD_SPLITTER.get())
											   .add(FABlocks.IRON_POWER_SHAFT.get(), FABlocks.IRON_GEARBOX.get(), FABlocks.IRON_SPLITTER.get())

...
public class FAItemModelProvider extends ItemModelProvider
{
	...
	protected void registerModels()
	{
		...
		basicItem(FAItems.TEA_LEAF.get());
		basicItem(FAItems.PANNED_TEA_LEAF.get());
		basicItem(FAItems.GREEN_TEA_LEAF.get());
		...
		FAItems.PIG_IRON_THINGS.forEach(this::metal);
		FAItems.STEEL_THINGS.forEach(this::metal);
		FAItems.ALUMINUM_THINGS.forEach(this::metal);
		FAItems.ALUMINUM_BRONZE_THINGS.forEach(this::metal);
		...
		basicItem(FAItems.LEATHER_PULLEY_BELT.get());

		basicItem(FAItems.TOASTED_BREAD.get());
		basicItem(FAItems.SLICED_BREAD.get());
		basicItem(FAItems.CHOCOLATE_ICE_CREAM.get());
		basicItem(FAItems.COFFEE_ICE_CREAM.get());
		basicItem(FAItems.COOKIES_N_CREAM_ICE_CREAM.get());
		...
		basicItem(FAItems.STEAMED_FISH.get());
